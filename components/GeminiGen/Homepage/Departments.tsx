...
const departments = [
  { title: "งานวิชาการ", desc: "พัฒนาการเรียนการสอนและหลักสูตร", icon: "📚", url: "/staff/academic-affairs-administration" },
  { title: "งานงบประมาณ", desc: "บริหารจัดการงบประมาณอย่างโปร่งใส", icon: "💰", url: "/staff/budget-finance-administration" },
  { title: "งานบุคลากร", desc: "ส่งเสริมวิชาชีพบุคลากรสู่ความเป็นเลิศ", icon: "👥", url: "/staff/personnel-administration" },
  { title: "งานบริหารทั่วไป", desc: "ดูแลอาคารสถานที่ให้ปลอดภัย", icon: "🏫", url: "/staff/general-administration" },
];
