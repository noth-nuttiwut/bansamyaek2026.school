  ...
  return (
    <section className="py-20 bg-[#FDFBF7]">
      <div className="max-w-7xl mx-auto px-6">
        ...
        {/* 📸 ส่วนแสดงภาพรวม */}
        <div className="animate-pulse w-full bg-gray-200 min-h-[1080px] rounded-[2rem] mb-5 flex justify-center items-center">
          <svg className="w-16 h-16 stroke-gray-400" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
